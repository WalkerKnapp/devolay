...
JNIEXPORT jlong JNICALL Java_com_walker_devolay_DevolayReceiver_receiveCreate
...
JNIEXPORT jlong JNICALL Java_com_walker_devolay_DevolayReceiver_receiveCreateDefaultSettings(JNIEnv *env, jclass jClazz) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_receiveDestroy(JNIEnv *env, jclass jClazz, jlong pReceiver) {
    delete reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver);
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_receiveConnect(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pSource) {
    getNDILib()->recv_connect(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver), reinterpret_cast<NDIlib_source_t *>(pSource));
}

JNIEXPORT jint JNICALL Java_com_walker_devolay_DevolayReceiver_receiveCaptureV2(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pVideoFrame, jlong pAudioFrame, jlong pMetadataFrame, jint timeout) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_freeVideoV2(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pVideoFrame) {
    getNDILib()->recv_free_video_v2(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver),
                              reinterpret_cast<NDIlib_video_frame_v2_t *>(pVideoFrame));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_freeAudioV2(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pAudioFrame) {
    getNDILib()->recv_free_audio_v2(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver),
                              reinterpret_cast<NDIlib_audio_frame_v2_t *>(pAudioFrame));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_freeMetadata(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pMetadataFrame) {
    getNDILib()->recv_free_metadata(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver),
                              reinterpret_cast<NDIlib_metadata_frame_t *>(pMetadataFrame));
}

JNIEXPORT jboolean JNICALL Java_com_walker_devolay_DevolayReceiver_receiveSendMetadata(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pMetadataFrame) {
    return getNDILib()->recv_send_metadata(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver),
                                     reinterpret_cast<NDIlib_metadata_frame_t *>(pMetadataFrame));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_receiveGetPerformance(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pTotalPerformance, jlong pDroppedPerformance) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_receiveClearConnectionMetadata(JNIEnv *env, jclass jClazz, jlong pReceiver) {
    getNDILib()->recv_clear_connection_metadata(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayReceiver_receiveAddConnectionMetadata(JNIEnv *env, jclass jClazz, jlong pReceiver, jlong pMetadataFrame) {
    getNDILib()->recv_add_connection_metadata(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver),
                                        reinterpret_cast<NDIlib_metadata_frame_t *>(pMetadataFrame));
}

JNIEXPORT jint JNICALL Java_com_walker_devolay_DevolayReceiver_receiveGetNoConnections(JNIEnv *env, jclass jClazz, jlong pReceiver) {
    return getNDILib()->recv_get_no_connections(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver));
}

JNIEXPORT jstring JNICALL Java_com_walker_devolay_DevolayReceiver_receiveGetWebControl(JNIEnv *env, jclass jClazz, jlong pReceiver) {
