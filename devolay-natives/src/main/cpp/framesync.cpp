...
JNIEXPORT jlong JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncCreate(JNIEnv *env, jclass jClazz, jlong pReceiver) {
    return (jlong) getNDILib()->framesync_create(reinterpret_cast<NDIlib_recv_instance_t *>(pReceiver));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncDestroy(JNIEnv *env, jclass jClazz, jlong pFramesync) {
    getNDILib()->framesync_destroy(reinterpret_cast<NDIlib_framesync_instance_t *>(pFramesync));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncCaptureAudio
...
/*JNIEXPORT jint Java_com_walker_devolay_DevolayFrameSync_framesyncAudioQueueDepth
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncFreeAudio
...
JNIEXPORT jboolean JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncCaptureVideo
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayFrameSync_framesyncFreeVideo
        (JNIEnv *env, jclass jClazz, jlong pFramesync, jlong pFrame) {
