...
#include "me_walkerknapp_devolay_DevolayFinder.h"

JNIEXPORT jlong JNICALL Java_me_walkerknapp_devolay_DevolayFinder_findCreate(JNIEnv *env, jclass jClazz, jboolean jShowLocalSources, jstring jGroups, jstring jExtraIps) {
...
JNIEXPORT jlong JNICALL Java_me_walkerknapp_devolay_DevolayFinder_findCreateDefaultSettings(JNIEnv *env, jclass jClazz) {
    auto *NDI_find_create = new NDIlib_find_create_t();
...
JNIEXPORT void JNICALL Java_me_walkerknapp_devolay_DevolayFinder_findDestroy(JNIEnv *env, jclass jClazz, jlong pFind) {
    getNDILib()->find_destroy(reinterpret_cast<NDIlib_find_instance_t>(pFind));
}

JNIEXPORT jlongArray JNICALL Java_me_walkerknapp_devolay_DevolayFinder_findGetCurrentSources(JNIEnv *env, jclass jClazz, jlong pFind) {
...
JNIEXPORT jboolean JNICALL Java_me_walkerknapp_devolay_DevolayFinder_findWaitForSources(JNIEnv *env, jclass jClazz, jlong pFind, jint jTimeout) {
