...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertToInterleaved16s(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertFromInterleaved16s(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertToInterleaved32s(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertFromInterleaved32s(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
    getNDILib()->util_audio_from_interleaved_32s_v2(reinterpret_cast<NDIlib_audio_frame_interleaved_32s_t *>(pSourceFrame),
                                                           reinterpret_cast<NDIlib_audio_frame_v2_t *>(pTargetFrame));
}

JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertToInterleaved32f(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
...
JNIEXPORT void JNICALL Java_com_walker_devolay_DevolayUtilities_convertFromInterleaved32f(JNIEnv *env, jclass jClazz, jlong pSourceFrame, jlong pTargetFrame) {
